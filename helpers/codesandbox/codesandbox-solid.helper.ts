...
<script src="index.tsx"></script>`;
  ...
  }${extensions.join(', ')} } from '@gov-standard-ui/solid';
import '@gov-standard-ui/solid/dist/gov-standard-ui.css';${[...extensions, ''].join('(); \n')}
...
`.trim();
  ...
  const projectDependencies = {
    ...
    'solid-js': '1.4.3',
    '@gov-standard-ui/solid': `${lernaJson.version}`
  };

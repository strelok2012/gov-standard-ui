...
body {
  --gsui-grid-gutter: 0.15rem;
  --gsui-color-primary-normal: #017af0;
...
`;
  ...
  if (html) {
    parameters.files[indexHTMLFolder] = {
      content: `${html}
<div class="footer">
<a href="https://gov-standard-ui.js.org" target="_blank" rel="noreferrer">
  Visit the docs at gov-standard-ui.js.org
</a>
</div>
      `
    };

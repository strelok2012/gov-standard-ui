...
export function generateReactCodeSandboxLink(options) {
  ...
  }${extensions.join(', ')} } from '@gov-standard-ui/react';
import '@gov-standard-ui/react/dist/gov-standard-ui.css';${[...extensions, ''].join('(); \n')}
...
`.trim();
  ...
  const projectDependencies = {
    ...
    react: '16.8.0',
    'react-dom': '16.8.0',
    '@gov-standard-ui/react': `${lernaJson.version}`
  };

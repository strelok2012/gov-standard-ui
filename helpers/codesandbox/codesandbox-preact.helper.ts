...
export function generatePreactCodeSandboxLink(options) {
  ...
  }${extensions.join(', ')} } from '@gov-standard-ui/preact';
import '@gov-standard-ui/preact/dist/gov-standard-ui.css';${[...extensions, ''].join('(); \n')}
...
`.trim();
  ...
  const projectDependencies = {
    ...dependencies,
    preact: '10.2.1',
    '@gov-standard-ui/preact': `${lernaJson.version}`
  };
